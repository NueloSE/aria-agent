...
/* React Bits "Prism" (WebGL via ogl), ported to TypeScript. Logic unchanged except
   for a guard so a missing WebGL context degrades silently instead of throwing. */
...
export default function Prism({
  ...
  useEffect(() => {
    ...
    try {
      ...
      console.warn("Prism: WebGL unavailable, skipping.", error);
      return;
    }
